...
class DatePicker {
  ...
  createIcon() {
    ...
    // Add click event if enabled - using class name selector
    if (this.options.iconClickOpens) {
      // Find the icon by class name and add event listener
      const iconElement = this.dom.inputWrapper.querySelector('.datepicker-icon');
      if (iconElement) {
  ...
  getCalendarHTML() {
    return `
            <div class="datepicker-header">
                <button type="button" class="datepicker-prev-btn" style="margin-right: 5px;" aria-label="Previous month">
                    <svg class="datepicker-prev-btn" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button type="button" class="datepicker-next-btn" style="margin-left: 5px;" aria-label="Next month">
                    <svg class="datepicker-next-btn" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
